  ...
  return (
    <div>
      ...
      <select defaultValue="publish-all">
        ...
        <option value="draft-all">Draft All</option>
      ...
      <ul id="wd-modules">
          ...
          <ul className="wd-lessons">
            ...
            <li className="wd-lesson">
              ...
              <ul className="wd-content">
                ...
                <li className="wd-content-item">Full Stack Developer - Chapter 2 - Createing User</li>
              </ul>
            </li>
            <li className="wd-lesson">
        ...
        <li className="wd-module">
          <div className="wd-title">Week 3 ,Lecture 2 - Formatting User Interface with HTML</div>
          <ul className="wd-lessons">
            <li className="wd-lesson">
              <span className="wd-title">LEARNING OBJECTIVES</span>
              <ul className="wd-content">
