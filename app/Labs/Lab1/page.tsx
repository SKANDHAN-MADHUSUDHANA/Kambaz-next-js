...
export default function Lab1() {
    return (
    <div id="wd-lab1">
        <h1>Skandhan Madhusudhana - Section: CS5610.19730.202610</h1>
        <h2>Lab 1</h2>
        <h3>HTML Examples</h3>
        <div id="wd-h-tag">
            <h4>Heading Tags</h4>
        ...
        This is my project&nbsp;<a href="https://github.com/SKANDHAN-MADHUSUDHANA/Kambaz-next-js" id="wd-kambaz-github">
           Github</a>&nbsp;
